...
public class FullscreenPhotoActivity extends AppCompatActivity {
    ...
    private final Runnable mHidePart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            ivPhotoDetail.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load(url).into(ivPhotoDetail);
    ...
    private void show() {
        // Show the system bar
        ivPhotoDetail.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mVisible = true;
